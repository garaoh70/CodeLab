// Typelib クラス追加ウィザードで作成された IDispatch ラッパー クラスがマシンで生成されました。
...
{
public:
	CRange() {} // COleDispatchDriver の既定のコンストラクターを呼び出します
...
public:
	...
	void InsertPictureInCell(LPCTSTR PictureURI)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0xd4a, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, PictureURI);
	}
	void PastePictureInCell()
	{
		InvokeHelper(0xd4d, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void PlacePictureOverCells(VARIANT& AsReference)
	{
		static BYTE parms[] = VTS_VARIANT;
		InvokeHelper(0xd4f, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, &AsReference);
	}
	void UpdatePictureInCellAlternativeText(LPCTSTR AlternativeText)
	{
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0xd52, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, AlternativeText);
	}
	LPDISPATCH get_CellControl()
	{
		LPDISPATCH result;
		InvokeHelper(0xd53, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	VARIANT ClearContents(VARIANT& RemoveControls)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT;
		InvokeHelper(0xd55, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &RemoveControls);
		return result;
	}
	void ResetContents()
	{
		InvokeHelper(0xd57, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void RemoveControls()
	{
		InvokeHelper(0xd56, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	void TogglePythonMarshalMode(VARIANT& MarshalMode)
	{
		static BYTE parms[] = VTS_VARIANT;
		InvokeHelper(0xd5b, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, &MarshalMode);
	}
