...
// CApplication ラッパー クラス

class CApplication : public COleDispatchDriver
{
public:
	CApplication() {} // COleDispatchDriver の既定のコンストラクターを呼び出します
...
public:
	...
	BOOL get_FormatStaleValues()
	{
		BOOL result;
		InvokeHelper(0xd49, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_FormatStaleValues(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xd49, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_MaxSupportedCompatibilityVersion()
	{
		long result;
		InvokeHelper(0xd59, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
